 ...
 */
public class cotizar_envio extends javax.swing.JDialog {

    /**
     * Creates new form programar_pickup
     */
    public cotizar_envio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cotizar_envio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                cotizar_envio dialog = new cotizar_envio(new javax.swing.JFrame(), true);
